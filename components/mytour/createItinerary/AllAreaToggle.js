...
export default function AllAreaToggle({ onRegionSelect, selectedRegions = [] }) {
...
const styles = StyleSheet.create({
  ...
  countryItem: { borderBottomWidth: 1, borderBottomColor: '#e5e7eb', paddingVertical: 16 },
  countryHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  countryInfo: { flexDirection: 'row', alignItems: 'center', flex: 1, marginRight: 12 },
  imageContainer: { marginRight: 12 },
  countryImage: { width: 36, height: 36, borderRadius: 8 },
  countryDetails: { flex: 1, justifyContent: 'center' },
  countryPreviewContainer: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  countryName: { fontSize: 16, fontWeight: '600', color: '#111827', flexShrink: 0 },
  separator: { fontSize: 14, color: '#6b7280', fontWeight: '400', flexShrink: 0 },
  regionPreviewText: { fontSize: 14, color: '#6b7280', flex: 1 },
  chevronIcon: { fontSize: 16, color: '#6b7280' },
  regionsContainer: { paddingTop: 16, paddingLeft: 40, paddingBottom: 8 },
  regionsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 4 },
  regionChip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, borderWidth: 1, borderColor: '#d1d5db', marginBottom: 4, marginRight: 4 },
  regionChipText: { fontSize: 14, color: '#000' },
});
