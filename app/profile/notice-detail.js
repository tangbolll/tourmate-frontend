...
const noticesData = [
  ...
  },
  {
    ...
    content: '안녕하세요, TOURMATE 팀입니다.\n더욱 즐겁고 편리한 여행 경험을 제공해 드리기 위해 AI 추천 기능 개선 및 여러 버그 수정 업데이트를 진행했습니다.\n\n[주요 업데이트 내용]\n\n1. AI 추천 기능 개선\n- 기존보다 더 정확하고 사용자 취향에 맞는 일정을 추천하도록 로직을 개선했습니다.\n- AI 추천 일정이 그리드에 표시될 때, 시각적으로 구분하기 쉽도록 새로운 스타일을 적용했습니다.\n\n2. 동행 기능 안정화\n- 동행 멤버를 수락할 때, 설정된 최대 인원을 초과하여 멤버를 받을 수 없도록 제한 기능이 추가되었습니다.\n\n3. UI/UX 개선\n- 앱 내 여러 화면에서 발생하던 사소한 정렬 문제들을 수정하여 사용성을 개선했습니다.\n\n앞으로도 TOURMATE는 여러분의 피드백을 바탕으로 꾸준히 발전해 나가겠습니다.\n감사합니다.',
    date: '2025.09.17',
  },
  {
    id: '2',
